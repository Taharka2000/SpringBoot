...
class DemoApplicationTests {
	...
	public void testCreateProduit() {
		Produit prod = new Produit("yooo", 20.5, new Date());
	...
	public void testFindByNomProduit() {
		List<Produit> prods = produitRepository.findByNomProduit("ps");
		for (Produit p : prods) {
			System.out.println(p);
		}
	}
	...
	public void testfindByNomPrix() {
		List<Produit> prods = produitRepository.findByNomPrix("Ps", 20.5);
		for (Produit p : prods) {
			System.out.println(p);
		}
	}
